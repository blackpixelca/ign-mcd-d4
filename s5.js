document.addEventListener("DOMContentLoaded", function () {
  ...
  poster1.from("#popup-1", { y: -80, rotation: -3, opacity: 0 }, "<+0.1");
  ...
  poster2.from("#popup-2", { y: -80, rotation: -3, opacity: 0 }, "<+0.1");
  ...
  poster3.from("#popup-3", { y: -80, rotation: -3, opacity: 0 }, "<+0.1");
  ...
  poster4.from("#popup-4", { y: -80, rotation: -3, opacity: 0 }, "<+0.1");
